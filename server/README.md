...
This directory contains the ARM Linux server side of the system.
...
- Raspberry Pi / ARM Linux deploy package is prepared in `systemd/*`, `config/nginx/*`, `scripts/install_pi.*`, `docs/deploy-pi.md`, `docs/deploy-pi-zero2w.md`, `docs/deploy-cardputerzero.md`.
...
- Raspberry Pi 5, Raspberry Pi Zero 2 W, and M5CardputerZero are valid ARM Linux server targets.
