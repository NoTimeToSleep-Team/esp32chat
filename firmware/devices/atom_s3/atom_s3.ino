/*
 * Atom S3 service firmware (standalone single-file sketch).
 *
 ...
 * - Standalone preset equivalent of firmware/arduino/presets/atom_s3_preset.h
 */
...
#ifndef LC_DEVICE_ID
#define LC_DEVICE_ID "atom-s3-01"
#endif

#ifndef LC_DEVICE_TYPE
#define LC_DEVICE_TYPE "atom_s3"
#endif
...
public:
    ...
    void begin() {
        Serial.println("atom s3 service runtime: boot");
...
RuntimeConfig make_atom_s3_standalone_config() {
...
RuntimeConfig kConfig = make_atom_s3_standalone_config();
