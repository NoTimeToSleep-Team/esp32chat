/*
 * ESP32 service firmware (standalone single-file sketch).
 *
 ...
 * - Standalone preset equivalent of firmware/arduino/presets/esp32_service_preset.h
 */
...
#ifndef LC_DEVICE_ID
#define LC_DEVICE_ID "esp32-service-01"
#endif

#ifndef LC_DEVICE_TYPE
#define LC_DEVICE_TYPE "esp32_service"
#endif
...
public:
    ...
    void begin() {
        Serial.println("esp32 service runtime: boot");
...
RuntimeConfig make_esp32_service_standalone_config() {
...
RuntimeConfig kConfig = make_esp32_service_standalone_config();
