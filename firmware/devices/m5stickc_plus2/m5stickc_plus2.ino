/*
 * M5StickC Plus2 client firmware (standalone single-file sketch).
 *
 ...
 * - chat/blog read probes
 * - optional chat send
 * - Standalone preset equivalent of firmware/arduino/presets/m5stickc_plus2_preset.h
 */
...
#ifndef LC_DEVICE_ID
#define LC_DEVICE_ID "m5stickc-plus2-01"
#endif

#ifndef LC_DEVICE_TYPE
#define LC_DEVICE_TYPE "m5stickc_plus2"
#endif
...
#define LC_SUPPORT_TITLE "M5Stick ticket"
#endif
...
void render() {
    ...
    M5.Display.fillRect(0, 0, M5.Display.width(), 14, 0x0204);
    M5.Display.setTextColor(0xFFFF, 0x0204);
...
public:
    ...
    void begin() {
        ui::set_phase("boot");
        Serial.println("m5stickc plus2 runtime: boot");
...
private:
    ...
    void maybe_send_chat_message() {
        ...
        const char* message_text = value_or_default(config_.chat_message_text, "hello from m5stickc plus2");
        const String payload = String("{\"session_token\":\"") + json_escape(session_token_) +
                               "\",\"body_text\":\"" + json_escape(String(message_text)) +
                               "\",\"client_message_id\":\"m5stick-" + String(millis()) + "\"}";
    ...
    void maybe_create_support_ticket() {
        ...
        const char* title = value_or_default(config_.support_ticket_title, "M5Stick ticket");
...
RuntimeConfig make_m5stickc_plus2_standalone_config() {
...
RuntimeConfig kConfig = make_m5stickc_plus2_standalone_config();
