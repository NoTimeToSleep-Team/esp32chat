...
| --- | --- | --- | --- |
| `esp32_service` | `devices/esp32_service/esp32_service.ino` | `arduino/presets/esp32_service_preset.h` | `verify_mvp.py`, `verify_sync_transport.py`, `verify_registration_e2e.py` |
...
| `m5cardputer_adv` | `devices/m5cardputer_client/m5cardputer_adv/m5cardputer_adv.ino` | `arduino/presets/m5cardputer_adv_preset.h` | `verify_alignment.py`, `ui/verify_flow.py` |
