...
This repository contains the staged implementation of a local distributed chat platform built around ARM Linux server targets and external hardware or handheld clients.
...
- `server/` - ARM Linux backend, web portal, data services, and admin APIs.
- `firmware/` - microcontroller firmware and client applications.
- `cardputerzero/` - M5CardputerZero-specific launcher and deployment assets.
